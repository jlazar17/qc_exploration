...
# Neutrino oscillation params from http://www.nu-fit.org/?q=node/228
class OscParams:

    def __init__(self, ordering='normal'):
        
        self.ordering = ordering
        if self.ordering=='normal':
            self.theta12 = np.radians(33.44)
            self.theta23 = np.radians(49.0)
